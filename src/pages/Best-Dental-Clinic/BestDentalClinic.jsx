        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "Organization",
              name: "Leo Dental",
              url: "https://www.leodental.co.in/best-dental-clinic-in-hsr-layout",
        ...
        <section className="bg-[#E2E2E2] py-10 flex flex-col gap-y-5 lg:gap-x-20 items-center px-6 lg:px-2">
          ...
          <div className="flex justify-between lg:flex-row flex-col w-full md:max-w-[1300px] md:mx-auto lg:gap-y-10 mt-10">
            ...
            <div className="w-full lg:w-[45%] h-[250px] lg:h-[60%] rounded-2xl">
              <img
                src="https://img.freepik.com/free-photo/dental-chair-other-accesorries-used-by-dentist-empty-cabinet-stomatology-cabinet-with-nobody-it-orange-equipment-oral-treatment_482257-12475.jpg?uid=P172451948&ga=GA1.1.517022815.1751973251&semt=ais_hybrid&w=740&q=80"
