  ...
  return (
    <>
      <Helmet>
        {/* Meta Tags */}
        <title>
          Best Dental Clinic In HSR Layout | Clear Aligners Clinic in Harlur
        </title>
        <meta
          name="description"
    ...
    `}
      ...
      <div className="pt-[75px]">
        <section className="w-full bg-[#ffe600] min-h-[752px] pt-16 pb-10 relative overflow-hidden">
          <div className="max-w-[1400px] mx-auto flex flex-col lg:flex-row items-center lg:items-start px-4">
            ...
            <div className="flex-1 flex flex-col justify-center lg:pl-10">
              <h1 className="font-bold text-[32px] lg:text-[48px] text-[#2d1a0b] leading-tight mb-4">
                NDC is Growing to Serve you
                <br />
                Better
              </h1>
              <p className="text-[20px] lg:text-[24px] text-[#2d1a0b] mb-2">
                10 Clinics in Hyderabad, 3 New Clinics in Bangalore
                <br />
                Now Expert Care and Pain-Free Smiles are always within reach
                from the{" "}
                <span className="font-bold">
                  best dental clinic in Hyderabad.
                </span>
              </p>
              <p className="font-semibold text-[18px] lg:text-[22px] text-[#2d1a0b] mb-4">
                <span className="font-bold">Advanced Treatments</span> |{" "}
                <span className="font-bold">Personalized Care</span> |{" "}
                <span className="font-bold">Commitment to Comfort</span>
              </p>
              {/* Stats Row */}
              <div className="flex flex-wrap gap-8 border-t border-b border-[#2d1a0b] py-6 my-6">
                <div className="flex flex-col items-center min-w-[100px]">
                  <span className="text-[32px] font-bold text-[#2d1a0b]">
                    13+
                  </span>
                  <span className="text-[16px] text-[#2d1a0b]">Branches</span>
                </div>
                <div className="flex flex-col items-center min-w-[100px]">
                  <span className="text-[32px] font-bold text-[#2d1a0b]">
                    22+
                  </span>
                  <span className="text-[16px] text-[#2d1a0b]">
                    Years Experience
                  </span>
                </div>
                <div className="flex flex-col items-center min-w-[100px]">
                  ...
                  <span className="text-[16px] text-[#2d1a0b]">Implants</span>
                </div>
                <div className="flex flex-col items-center min-w-[100px]">
                  <span className="text-[32px] font-bold text-[#2d1a0b]">
                    2L
              ...
              {/* Enquire Button */}
              <button className="bg-[#2d1a0b] text-white rounded-full px-8 py-3 text-lg font-semibold mt-2 w-fit">
                ENQUIRE
              </button>
            </div>
            {/* Right Image */}
            <div className="flex-1 flex justify-center lg:justify-end mt-10 lg:mt-0 relative">
              <div className="w-full max-w-[500px] h-auto rounded-3xl shadow-lg overflow-hidden">
                <img
                  src={girl}
                  alt="Dental Clinic"
                  className="w-full h-auto object-cover rounded-3xl lg:block hidden"
                />
              </div>
              {/* Trusted by badge */}
              <div className="lg:block hidden absolute bottom-8 left-1/2 lg:left-auto lg:right-10 transform -translate-x-1/2 lg:translate-x-0 bg-white/80 rounded-xl px-6 py-4 shadow-lg flex items-center gap-3">
                <span className="text-[#ffb800] text-2xl font-bold">✔</span>
                <span className="text-[#2d1a0b] font-semibold text-lg">
                  Trusted by
                  <br />
          ...
          {/* Optional: Add background tooth icons with absolute positioning for design */}
        </section>

        <div className="w-full bg-white border-gray-200 py-4 px-6">
          <div className="lg:block hidden">
            <div className="max-w-7xl mx-auto flex items-center justify-between bg-white p-10 rounded-lg shadow-md relative bottom-16">
              {/* Contact Information */}
              ...
              <button className="bg-amber-900 hover:bg-amber-800 text-white px-6 py-3 rounded-full font-semibold text-base">
                Book an Appointment
              </button>
            </div>
          </div>
          ...
          <div className="lg:hidden">
            <div className="flex flex-col space-y-4 mt-4 p-5 rounded-lg shadow-md relative bottom-16 z-10 bg-white">
              {/* Contact and Hours in Mobile */}
              <div className="flex flex-col justify-center items-start">
                ...
                <div className="flex items-center space-x-2 mt-5">
                  ...
                  <div>
                    <p className="text-xs text-gray-600">Visiting Hours</p>
                    <p className="text-sm font-bold text-gray-900">
                      Mon - Sun 9 AM to 9 PM
                    </p>
                  </div>
              ...
              {/* Button in Mobile */}
              <button className="bg-amber-900 hover:bg-amber-800 text-white w-full py-3 rounded-full font-semibold">
                Book an Appointment
              </button>
            </div>
          </div>
        ...
        <section className="max-w-[1350px] mx-auto  pb-20">
          ...
          >
            {service.map((item, index) => (
              <SwiperSlide key={index}>
                <div className="rounded-2xl shadow-xl border-2 lg:w-[392px] h-[515px] mx-auto">
                  ...
                  <div className="mt-5 lg:px-10 mx-5">
                    ...
                    <Link
                      to={item.path}
                      className="text-reds underline text-lg"
                    >
                      Learn More
                    </Link>
                  </div>
