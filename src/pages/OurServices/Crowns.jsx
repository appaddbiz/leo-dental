  ...
  return (
    <>
      <Helmet>
        ...
        <title>Dental Crowns in HSR Layout | Leo Dental Clinic</title>
        <meta
          name="description"
          content="Get durable and natural-looking dental crowns at Leo Dental Clinic, HSR Layout. Expert fit, quality materials & lasting smile restoration.
"
        />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "Organization",
              name: "Dental Crowns in HSR Layout | Leo Dental Clinic",
              url: "https://www.leodental.co.in/service/Dental-Crowns",
              ...
              description:
                "Get durable and natural-looking dental crowns at Leo Dental Clinic, HSR Layout. Expert fit, quality materials & lasting smile restoration.",
              keywords: [
                "Dental crowns HSR Layout",
                "Tooth crown in HSR Layout",
                "Best dental crown clinic HSR Layout",
                "Affordable dental crowns HSR Layout",
                "Cosmetic dental crowns HSR Layout",
              ],
      ...
      <div className="pt-20">
        ...
        <section className="max-w-[1400px] px-4 lg:px-0 mx-auto mt-[80px]">
          <div className="relative ">
            ...
            <p className="lg:text-[22px] text-[18px] lg:leading-8">
              ...
              over a carefully prepared existing tooth. It is used to
              strengthen, restore, or improve the appearance of your natural
              tooth. A crown is placed on an individual tooth much like a
              thimble over your finger. In addition to being used to strengthen
              a tooth or to accommodate the attachment of a fixed bridge, crowns
              serve many functions. One of the most common indications is to
              support the tooth when there is no longer sufficient tooth
              structure left to place a filling. Crowns may also be used to
              protect the structure of a tooth that is fractured or broken.
              <h2 className="inline">
                Dental Crowns and Bridges in HSR Layout Bangalore
              </h2>
              are a trusted solution for restoring dental aesthetics and
              function with long-lasting results.
            </p>
          </div>
        </section>
        <section className="max-w-[1400px] px-2 lg:px-0 mx-auto mt-10 lg:mt-[80px]">
          ...
          <p className="lg:text-[22px] lg:leading-8 mt-4 font-medium">
            There are two types of ceramic crowns namely Porcelain Fused to
          ...
          <p className="lg:text-[22px] lg:leading-8 mt-5">
            ...
            considered as gold standard for repair of damaged teeth and they
            have ruled dentistry for several decades.
          </p>{" "}
          <p className="lg:text-[22px] lg:leading-8 mt-5">
            <span className="text-reds font-medium">
              In All Ceramic Crowns,
            </span>{" "}
            the entire thickness of the crown is made out of porcelain. These
            type of crowns are also mentioned as Metal free crowns and are most
